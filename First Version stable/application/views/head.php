...
<head>
    <title>script</title>
    <link rel="stylesheet" href="./codemirror-5.37.0/lib/codemirror.css">
    <style type="text/css">/**
 ...
 */
        ...
        .cm-s-darcula .CodeMirror-matchingbracket { outline:1px solid #A9B7C6; color: yellow !important; }</style>

    <link rel="stylesheet" href="./style.css" />
    <script src="./jquery-3.3.1.min.js"></script>
    <script src="./codemirror-5.37.0/lib/codemirror.js"></script>
    <script src="./codemirror-5.37.0/addon/edit/matchbrackets.js"></script>
    <script src="./codemirror-5.37.0/mode/htmlmixed/htmlmixed.js"></script>
    <script src="./codemirror-5.37.0/mode/xml/xml.js"></script>
    <script src="./codemirror-5.37.0/mode/javascript/javascript.js"></script>
    <script src="./codemirror-5.37.0/mode/css/css.js"></script>
    <script src="./codemirror-5.37.0/mode/clike/clike.js"></script>
    <script src="./codemirror-5.37.0/mode/php/php.js"></script>
</head>